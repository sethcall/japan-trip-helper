    ...
    <div class="layout">
        ...
        <main class="content">
            ...
            <div style="margin-bottom: 30px;">
                <img src="assets/infographics/akihabara_stores.png" alt="Akihabara Stores" style="max-width: 100%; height: auto; display: block; margin: 0 auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            </div>
